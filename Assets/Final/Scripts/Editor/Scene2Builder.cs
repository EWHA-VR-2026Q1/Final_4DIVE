...
public class Scene2Builder : Editor
{
    ...
    [MenuItem("EDEN/Register Scenes (Final only)")]
    static void RegisterHW09Scenes()
    {
        string[] guids = AssetDatabase.FindAssets("t:Scene", new[] { "Assets/Final/Scenes" });
        AddScenesToBuildSettings(guids);
        EditorUtility.DisplayDialog("EDEN", "Final 씬 등록 완료!", "OK");
    }
