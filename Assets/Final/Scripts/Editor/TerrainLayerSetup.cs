...
public class TerrainLayerSetup
{
    ...
    {
        var dirtTex  = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Final/eunheay/Fantasy Forest Environment Free Sample/Textures/dirt01.tga");
        var grassTex = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Final/eunheay/Fantasy Forest Environment Free Sample/Textures/grass01.tga");
        ...
        string savePath = "Assets/Final/eunheay/";
