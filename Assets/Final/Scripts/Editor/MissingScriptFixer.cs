...
public static class MissingScriptFixer
{
    ...
    {
        EditorSceneManager.OpenScene("Assets/Final/Scenes/MainScene.unity", OpenSceneMode.Single);
    ...
    {
        EditorSceneManager.OpenScene("Assets/Final/Scenes/Scene3_A.unity", OpenSceneMode.Single);
    ...
    public static void WireScene3AReferences()
    {
        ...
        string[] audioGuids = AssetDatabase.FindAssets("t:AudioClip", new[] { "Assets/Final/heejo/Audio" });
    ...
    {
        EditorSceneManager.OpenScene("Assets/Final/Scenes/Scene4_B.unity", OpenSceneMode.Single);
