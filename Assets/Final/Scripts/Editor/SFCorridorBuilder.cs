...
public class SFCorridorBuilder : EditorWindow
{
    ...
    public static void BuildCorridor()
    {
        ...
        AssetDatabase.CreateAsset(whiteMat, "Assets/Final/Materials/SF_White.mat");
        ...
        AssetDatabase.CreateAsset(darkMat, "Assets/Final/Materials/SF_Dark.mat");
        ...
        AssetDatabase.CreateAsset(glowMat, "Assets/Final/Materials/SF_Glow.mat");
